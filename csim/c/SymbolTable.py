...
class SymbolTable:
    def __init__(self):
        ...
        self.define(self._createSymbol("_Float16x", TypeClassification.TypeSpecifier_))
        self.define(self._createSymbol("_Float32x", TypeClassification.TypeSpecifier_))
        self.define(self._createSymbol("_Float64x", TypeClassification.TypeSpecifier_))
        self.define(self._createSymbol("_Float128x", TypeClassification.TypeSpecifier_))
