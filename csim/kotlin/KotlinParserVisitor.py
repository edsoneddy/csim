...
class KotlinParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by KotlinParser#explicitBackingField.
    def visitExplicitBackingField(self, ctx:KotlinParser.ExplicitBackingFieldContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by KotlinParser#functionModifierList.
    def visitFunctionModifierList(self, ctx:KotlinParser.FunctionModifierListContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by KotlinParser#contextParameters.
    def visitContextParameters(self, ctx:KotlinParser.ContextParametersContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by KotlinParser#contextModifier.
    def visitContextModifier(self, ctx:KotlinParser.ContextModifierContext):
        return self.visitChildren(ctx)
